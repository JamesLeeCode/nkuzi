    ...
    <div id="heroCarousel" class="container carousel carousel-fade" data-bs-ride="carousel" data-bs-interval="5000">
      ...
      <div class="carousel-item active">
        <div class="carousel-container">
          <h2 class="animate__animated animate__fadeInDown">Welcome to <span>Nkuzi Development Association NPC</span></h2>
          <p class="animate__animated animate__fadeInUp">Nkuzi Development Association NPC was established in 1997 in response to the need to assist communities within the Makhado area to lodge land claims after the introduction of the Restitution of Land Rights Act   No. 22 of 1994. By then the offices of the Land Claims Commission were only in Pretoria</p>
      ...
      <div class="carousel-item">
        <div class="carousel-container">
          <h2 class="animate__animated animate__fadeInDown">Nkuzi - Vision </h2>
          <p class="animate__animated animate__fadeInUp">Land is available, accessible, and effectively utilized by previously landless and marginalized people.</p>
          <a href="about.html" class="btn-get-started animate__animated animate__fadeInUp">Read More</a>
        </div>
      </div>
      ...
      <div class="carousel-item">
        <div class="carousel-container">
          <h2 class="animate__animated animate__fadeInDown">Our Main Programme Areas</h2>
          <p class="animate__animated animate__fadeInUp">These are Land Reform Implementation, Farm Dweller, Research and Policy, and Legal Services. The land Reform Implementation programme has small projects such as Community Organizing and Training and Sustainable Livelihoods Promotion and Support. Research and Policy has a sub project Area Land Reform Initiative which is exploring new ways of addressing landlessness in the country.</p>
          <a href="about.html" class="btn-get-started animate__animated animate__fadeInUp">Read More</a>
        </div>
      </div>
          ...
          <div class="col-lg-12 entries">
            ...
            <article class="entry entry-single">
              ...
              <h2 class="entry-title">
                <a href="">Welcome Massege by Executive Director</a>
              </h2>
              ...
              <div class="entry-content">
                ...
                <h3>VIVA Nkuzi Development Association VIVA.</h3>
                  ...
                  <div class="container">
                    ...
                    <div class="row">
                      <div class="col-md-3 d-flex align-items-stretch" data-aos="fade-up">
                        <div class="card">
                          <div class="card-img">
                            <img src="images/index1.fw.png" alt="...">
                          </div>
                          <div class="card-body">
                            <p class="card-text">Nkuzi Development Association The Executive Director Motlanalo Lebepe</p>
                          </div>
                        </div>
                      </div>
                      <div class="col-md-3 d-flex align-items-stretch" data-aos="fade-up">
                        <div class="card">
                          ...
                          <div class="card-body">
                            <p class="card-text">Nkuzi Development Association at Mogalakwena(Student Uniform Handover)</p>
                          </div>
                        </div>
                      ...
                      <div class="col-md-5 d-flex align-items-stretch" data-aos="fade-up">
                        <div class="card">
                          ...
                          <div class="card-body">
                            <p class="card-text">Woman International Day Celebration ,Hosted by Nkuzi Development Association The event was held at The Chuene Resort</p>
                          </div>
                        </div>
                      </div>
                    </div>
