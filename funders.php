...
<head>
  ...
  <title>Nkuzi Development Association - Funders</title>
    ...
    <section class="breadcrumbs">
      <div class="container">
        ...
        <div class="d-flex justify-content-between align-items-center">
          <h2>List of Our Funders / Donors</h2>
          <ol>
            <li><a href="index.php">Home</a></li>
            <li>List of Our Funders / Donors</li>
          </ol>
        </div>
      ...
      <div class="container">
        ...
        <div class="gallery" id="gallery">
          <div class="gallery-item">
              <div class="content"><img src="images/Breadfortheworldlogo.png" alt=""></div>
          </div>
          <div class="gallery-item">
              <div class="content"><img src="images/funders.png" alt=""></div>
          </div>
          <div class="gallery-item">
              <div class="content"><img src="images/funder3.jpg" alt=""></div>
          </div>
        ...
        <div class="row">
          <div class="col-md-6 col-lg-3 align-items-stretch" data-aos="fade-up">
            <div class="icon-box icon-box-pink">
              ...
              <h4 class="title"><a href="">DKA Austria</a></h4>
            </div>
          </div>
          ...
          <div class="col-md-6 col-lg-3 align-items-stretch" data-aos="fade-up" data-aos-delay="100">
            <div class="icon-box icon-box-cyan">
              ...
              <h4 class="title"><a href="">National Development Agency (NDA)</a></h4>
            </div>
          </div>
          ...
          <div class="col-md-6 col-lg-3 align-items-stretch" data-aos="fade-up" data-aos-delay="200">
            <div class="icon-box icon-box-green">
              ...
              <h4 class="title"><a href="">EED</a></h4>
          </div>
          </div>
          ...
          <div class="col-md-6 col-lg-3 align-items-stretch" data-aos="fade-up" data-aos-delay="200">
            <div class="icon-box icon-box-blue">
              ...
              <h4 class="title"><a href="">Foundation for Human Rights (FHR)</a></h4>
            </div>
          </div>
